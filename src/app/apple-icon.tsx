...
// iOS home-screen / Safari icon. iOS applies its own corner mask, so the
// tile fills the full square instead of using the rounded-corner radius.
export default function AppleIcon() {
  return new ImageResponse(
    (
      <div style={{ display: "flex", width: "100%", height: "100%" }}>
        <svg width="180" height="180" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
          <rect width="512" height="512" fill="#215c24" />
          <path
            fill="#dcefdc"
